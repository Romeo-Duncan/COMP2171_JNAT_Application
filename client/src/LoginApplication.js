    ...
    <Router>
      <div>
        <Routes>
          ...
          <Route path='admin' element={<><LogoutComponent onLoggedOut = {onLoggedOut} userType = {userType}/><AdminApplication/></>}/>
          <Route path='employee' element={<><LogoutComponent onLoggedOut = {onLoggedOut} userType = {userType}/><EmployeeApplication userId={userId}/></>}/>
          <Route path='customer' element={<><LogoutComponent onLoggedOut = {onLoggedOut} userType = {userType}/><CustomerApplication userId={userId}/></>}/>
        </Routes>        
      </div>
    </Router>
  )
